...
<body class="dashboard" style="font-family: 'Arial','Hiragino Sans GB', \5fae\8f6f\96c5\9ed1, 'Helvetica', 'sans-serif';">
  ...
  <div class="page animsition">
	<div class="page-header">
      <h1 class="page-title">在线人数</h1> 当前在线人数：${onLineNum }   
    </div>
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          <div id="select" class="form-group">
                    ...
                    <ul id="test">
                       <li><a href="loginCount.html?time=1">一天</a></li>
                       <li><a href="loginCount.html?time=2">一周</a></li>
                        <li><a href="loginCount.html?time=3">一个月</a></li>
                    </ul>
